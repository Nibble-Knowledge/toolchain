...
./label-replacer/lr4 label-replacer/examples/deffiles/standard.def "out-lrasm" "out-llasm" || { rm out-macro out-lrasm out-llasm; exit 1; }
./cpu-assembler/as4 "out-llasm" "$2" || { rm out-macro out-lrasm out-llasm; exit 1; }
